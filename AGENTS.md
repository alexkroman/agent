...
Four files sit outside the table for a different reason:
`packages/aai-server/MODAL-CLAUDE.md`, `packages/aai-server/SCHEMA-CLAUDE.md`,
`packages/aai-runtime/JOURNAL-CLAUDE.md` and
`packages/aai-templates/PORTS-CLAUDE.md`, SIBLINGS of their package's guide
