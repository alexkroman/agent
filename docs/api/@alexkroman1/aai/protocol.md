...
Takes an ALREADY-STAMPED [SessionEvent](index.md#sessionevent): the envelope is minted once,
...
[`SessionEvent`](index.md#sessionevent)
...
Re-exports [ClientConfigResponseSchema](workflow-api.md#clientconfigresponseschema)
