...
export const SESSION_ERROR_SITES: readonly SessionErrorSite[] = [
  ...
  },
  {
    ...
    driven: {
      owner: "packages/aai-runtime/runtime-tools.ts",
      why:
  ...
  // ── The socket layer above the transports ─────────────────────────────────
  {
    ...
    recovery: "terminated",
    driven: {
      owner: "packages/aai-runtime/session-decline.ts",
      why:
  ...
  },
  {
    ...
    recovery: "terminated",
    driven: {
      owner: "packages/aai-runtime/ws-handler.ts",
  ...
  // ── S2S: the vendor owns the turn, so the codes differ ────────────────────
  {
    ...
    recovery: "reported-only",
    driven: {
      owner: "packages/aai-runtime/integration/s2s-fuzz.integration.test.ts",
      why:
