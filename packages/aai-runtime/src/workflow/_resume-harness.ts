 ...
 *
 * The bodies themselves are `workflow/_resume-program.ts`, shared with the other
 ...
 * `workflow/_rebuild-harness.ts`. The model below keeps the process (and its
 ...
 * `workflow/_resume-program.ts` directly, as `workflow/_rebuild-harness.ts`
 * does.
 */
export {
  expectedOutput,
