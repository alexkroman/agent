...
import type { CodeChange } from "../code-version.ts";
import type { StepEntry } from "../journal/types.ts";
...
export function watchDivergence(
   ...
   * and `workflow/_resume-harness.ts` generates it — and on a replay the OUTER
