 ...
 * things: the two generated crash models (`workflow/_resume-harness.ts`,
 * `workflow/_rebuild-harness.ts`), which drive bodies from a grammar and
 ...
 * `workflow/_rebuild-harness.ts`'s whole subject — it builds a real
