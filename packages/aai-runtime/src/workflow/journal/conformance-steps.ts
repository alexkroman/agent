 ...
 * backend answers.
 *
 * Split from `workflow/journal/conformance-cases.ts` along the seam that file's own
 ...
 * it past the 500-line cap. Same shape as `workflow/journal/conformance-waits.ts` beside
 * it, and `workflow/journal/conformance.ts` composes all of them.
 *
