 ...
 *
 * `workflow/journal/conformance.ts` is the entry point and carries the whole argument
 * for the pattern, the four arms and the rules for a new case. This file is the
 * third of its case modules, split off `workflow/journal/conformance-cases.ts` at the
