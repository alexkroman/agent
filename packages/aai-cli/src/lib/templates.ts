...
import { isDevMode } from "./discover.ts";
...
function resolveLocalTemplatesDir(): string {
  ...
  // From source: cliDir is packages/aai-cli/src/lib/, sibling package is ../../../aai-templates
  // From dist:   cliDir is packages/aai-cli/dist/, sibling package is ../../aai-templates
