 ...
 * (`studio/_eval-harness.ts`) is what made that worth doing: a second caller
...
import { type HarnessState, loadBundle } from "aai-guest-core/bundle";
import { executeTool } from "aai-guest-core/trial";
