...
import { bundledTemplatesRoot } from "./studio-template-tools.ts";
import { runWorkspaceTests } from "./studio-test.ts";
import { HARD_TURN_MS } from "./studio-turn-budget.ts";
 ...
 *
 * Exported for `_studio-eval-harness.test.ts` — this module's own seams. A
