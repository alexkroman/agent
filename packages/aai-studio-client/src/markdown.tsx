...
// Module scope: fresh element renderers per render would give the markdown
// tree new component types each time, forcing a full re-reconcile of every
// message on every streamed chunk (and defeating the memo below).
const components: Components = {
  ...
  a: (props) => (
    <a className="text-indigo underline" target="_blank" rel="noreferrer noopener" {...props} />
  ),
  ...
  table: (props) => <table className="my-1.5 w-full border-collapse text-[12px]" {...props} />,
...
/**
 * Assistant prose, rendered as Markdown. Memoized — settled messages keep
 * their text, and a remark parse per streamed chunk is the transcript's
 * hottest path.
 *
