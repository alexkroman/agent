...
// `components/api-docs.tsx` and the upload section in `components/docs-uploads.tsx` — and a second
// copy is how one of them ends up without the disclosure, or with the languages
// in the other order. Same argument as `components/snippet.tsx`, which this is built out
// of.
