...
/**
 * `@alexkroman1/aai/slugify` — how a human-supplied name becomes a platform slug.
 *
 * A FACADE. The subpath resolves here rather than at `slugify.ts`, which buys two
...
export { slugifyName } from "./slugify.ts";
