...
/**
 * Frozen authoring example: `aai:testing` epoch 28 — the step slots.
 *
 * The second half of {@link ../testing/v28.ts | v28.ts} and part of the SAME
 ...
 * the seam the file already had is the section banner. Every rule in `v28.ts`'s
 ...
 * the mechanism.
 *
 * The gate reads `v28.ts` by name (`fixturePath` in
...
/** Composing a model leg with a page leg — epoch 28's one fake for two far sides. */
