 ...
 * carrying only two of them while declaring `llm: openai(...)`. `resolveLlm`
...
import { OPENAI_API_KEY_ENV, openai } from "../../sdk/providers/llm/openai.ts";
import { ASSEMBLYAI_API_KEY_ENV, assemblyAIStt } from "../../sdk/providers/stt/assemblyai.ts";
import { CARTESIA_API_KEY_ENV, cartesia } from "../../sdk/providers/tts/cartesia.ts";
