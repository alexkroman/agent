 ...
 *
 * `link-digest-workflow` shows these primitives raw, `transcription-workflow` shows the form
 * layer in full, and `spoken-summary-workflow` shows how a page plays a file the RUN
      ...
      {output !== undefined && (
        <article className="flex flex-col gap-6">
          ...
          {/* The SDK's player over the hook's result: the pending line, the
              ...
              `spoken-summary-workflow` passes one instead — worth reading, if a real
