 ...
 *
 * ## What makes this a different KIND of workflow app from `link-digest-workflow`
 *
 * `link-digest-workflow` is the smallest one: one URL in, one digest out, run over. This
