 ...
 *
 * `link-digest-workflow` is the page that writes its one control by hand, deliberately,
 * so a reader can see what this layer stands on. `document-redline-workflow` is the MIXED case —
 * declared scalars beside one hand-written array field.
 *
 * ## What a SCHEDULED run adds to `link-digest-workflow`'s page
 *
