...
/** One lookup for the draft and the frozen value alike (see `emergency-dispatch-agent`). */
 ...
 *
 * The hang-up is declared ONCE, on the parent (see `roadside-assistance-agent`), and it
