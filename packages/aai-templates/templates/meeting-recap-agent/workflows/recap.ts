 ...
 * ported into.
 *
 * Read `research-handoff-agent/workflows/research.ts` first for the two rules every
 ...
 * work — the same bound `link-digest-workflow` puts on article text, for the same
 ...
 *
 * Separate from the polling on purpose, and for the same reason `link-digest-workflow`
