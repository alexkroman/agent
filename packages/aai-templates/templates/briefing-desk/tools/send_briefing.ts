import { errorMessage, isToolFailure, requireEnv, toolFailure } from "@alexkroman1/aai";
 ...
 * to set it, and the runtime hands that to the model rather than letting the
 * first property access surface as a `TypeError` the caller hears as an
 * unexplained apology. Everything a call CAN recover from is a `ToolFailure`
 * below.
 */
