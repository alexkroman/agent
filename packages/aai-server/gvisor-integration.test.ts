 ...
 * error propagation, and shutdown — all running inside a real gVisor OCI
 * container with stdio pipes. Filesystem/network/resource restriction tests
 * live in gvisor-integration-isolation.test.ts.
 *
