...
import { GUEST_EGRESS_DEFAULT, GUEST_INGRESS_DEFAULT, guestEgressRules } from "./network.ts";
import type { MicrosandboxProcLike, MicrosandboxSpawnContext } from "./sandbox.ts";
